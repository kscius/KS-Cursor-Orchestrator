...
## Example Use Cases
- â€œRefactor a set of AD scripts into a reusable moduleâ€  
- â€œCreate a standardized profile for helpdesk teamsâ€  
- â€œDesign a cross-platform automation toolkitâ€  

## Integration with Other Agents
- **powershell-5.1-expert / powershell-7-expert** â€“ implementation support  
- **windows-infra-admin / azure-infra-engineer** â€“ domain-specific functions  
- **m365-admin** â€“ workload automation modules  
- **it-ops-orchestrator** â€“ routing of module-building tasks  
