...
```bash
# Use project-appropriate command — verify from package.json/Makefile/CI first
npm test
cargo test
pytest
go test ./...
...
- **Skipping ignore verification** → Worktree contents tracked, pollute git status
...
**Called by:**
- `writing-plans` — Set up isolated workspace after design approval
